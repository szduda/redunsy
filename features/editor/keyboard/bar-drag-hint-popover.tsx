...
export const BarDragHintPopover = () => (
  ...
  >
    {({ open, toggle }) => (
      <button
        className={cn(
          'absolute bottom-full left-1/2 m-1 hidden -translate-x-1/2 rounded-md bg-yellowy-light/10 px-2 py-1.5 text-sm text-zinc-500 transition-colors hover:bg-yellowy-light/20 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 md:block',
