...
export const Homepage = () => (
  <div className="flex min-h-dvh flex-1 lg:ml-[5%] xl:ml-[10%] 2xl:ml-[15%]">
    <HomepageNav />
    <HomepageFabricStripe />

    <main className="relative z-10 flex min-w-0 flex-1 flex-col gap-10 px-6 py-8 md:max-w-2xl md:gap-12 md:py-12 md:mx-4 lg:mx-12 xl:mx-24 lg:mt-8">
