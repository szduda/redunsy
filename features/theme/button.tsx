...
const base =
  'inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors duration-150 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50'
...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border border-zinc-300 text-zinc-900 hover:border-zinc-400 hover:bg-zinc-100 active:bg-zinc-200 dark:border-zinc-700 dark:text-zinc-100 dark:hover:border-zinc-500 dark:hover:bg-zinc-800 dark:active:bg-zinc-700',
  link: '',
}
